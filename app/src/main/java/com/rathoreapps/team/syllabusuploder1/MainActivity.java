        ...
        addSyllabusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (syllabusLayout.getVisibility() == View.GONE) {
                    ...
                    if (subjectListAdapter.getCount() == 0){
                    ...
                    }else {subjectName = subjectListSpinner.getSelectedItem().toString();
                        ...
                        if (subjectName.isEmpty()) Toast.makeText(context, "Please Select any Subject", Toast.LENGTH_SHORT).show();
                        else if (unitNo.isEmpty()) Toast.makeText(context, "Enter Unit No", Toast.LENGTH_SHORT).show();
                        else if (chapterName.isEmpty()) Toast.makeText(context, "Enter Chapter Name", Toast.LENGTH_SHORT).show();
                        else if (content.isEmpty()) Toast.makeText(context, "Enter Content", Toast.LENGTH_SHORT).show();
